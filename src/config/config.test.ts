...
describe("resolveConfig", () => {
  ...
  it("throws a clear error on a non-numeric numeric env var", () => {
    expect(() => resolveConfig(null, { GRUGLING_MAX_TOKENS: "lots" })).toThrow(/GRUGLING_MAX_TOKENS/);
  });
});
